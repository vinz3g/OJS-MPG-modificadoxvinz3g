...
{call_hook name="Templates::Common::Footer::PageFooter"}
	<div id="standardFooter">
		<p>ISSN: {$issn}</p>
		<p>Publicada por el <a href="http://www.cirbiomedicas.uady.mx">Centro de Investigaciones Biomédicas "Dr. Hideyo Noguchi"</a>, de la <a href="http://www.uady.mx">Universidad Autónoma de Yucatán</a>.</p>
	</div>
</div>
